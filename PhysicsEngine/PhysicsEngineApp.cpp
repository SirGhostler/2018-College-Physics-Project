...
bool PhysicsEngineApp::startup()
{
	...
	collAABB1 = new AABB(glm::vec2(30, 0), glm::vec2(-8, 0), glm::vec2(0, 0), glm::vec2(5, 10), 2.0f, 1, glm::vec4(1, 1, 1, 1));	m_physicsScene->addActor(collAABB1); // White
	collAABB2 = new AABB(glm::vec2(-30, 0), glm::vec2(8, 0), glm::vec2(0, 0), glm::vec2(5, 10), 2.0f, 1, glm::vec4(0, 1, 1, 1));	m_physicsScene->addActor(collAABB2);
